"""start of merged model

Revision ID: 72c36685b3ad
Revises: 
Create Date: 2024-04-16 13:28:46.337141
...
def upgrade() -> None:
    ...
    sa.Column('designation', sa.Enum('ADMIN', 'DEVICE_MANAGER', 'STAFF', 'VIEWER', name='designation'), nullable=False),
    ...
    op.create_table('maintainance_history',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('maintainance_history')
